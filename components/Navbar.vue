<template>
  <div>
    <header
      class="nav-opt-sprite nav-location-us nav-lang-en nav-ssl nav-unrec"
    >
              ...
              <nuxt-link to="/address" class="nav-a nav-a-2">
                ...
                <div id="glow-ingress-block">
                  <span class="nav-line-1" id="glow-ingress-line1"
                    >Deliver to</span
                  >
                  <span class="nav-line-2" id="glow-ingress-line2">Lagos</span>
                </div>
              </nuxt-link>
            </div>
          </div>
            ...
            <div class="nav-tools">
              ...
              <template v-else>
                <nuxt-link
                  ...
                  tabindex="0"
                >
                  <span class="nav-line-1">Hello, Login</span>
                  <span class="nav-line-2"
                    >Account &amp; List
                    <span
                      class="nav-icon nav-arrow"
...
export default {
  ...
  async mounted() {
    ...
    let response = await this.$axios.$get("/api/auth/user", config);
